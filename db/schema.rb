...
ActiveRecord::Schema[8.1].define(version: 2026_05_10_120445) do
  ...
  create_table "collection_items", force: :cascade do |t|
    ...
    t.index ["collection_id", "product_id"], name: "index_collection_items_on_collection_id_and_product_id", unique: true
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.string "brand"
    t.integer "case_depth_in_mm"
    t.integer "case_length_in_mm"
    t.integer "case_weight_in_g"
    t.integer "case_width_in_mm"
    ...
    t.boolean "sample_eligible", default: true, null: false
    t.string "size"
  ...
  create_table "site_settings", force: :cascade do |t|
    ...
    t.string "hero_title_line1"
    t.string "hero_title_line2"
    t.datetime "updated_at", null: false
  end
