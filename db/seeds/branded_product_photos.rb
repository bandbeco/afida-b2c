...
branded_products = Product.where(product_type: 'customizable_template')
puts "  Branded products with product_photo: #{branded_products.joins(:product_photo_attachment).count}"
puts "  Branded products with lifestyle_photo: #{branded_products.joins(:lifestyle_photo_attachment).count}"
