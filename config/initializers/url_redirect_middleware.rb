...
require Rails.root.join("app/middleware/url_redirect_middleware")

# Register URL redirect middleware early in stack for better performance
...
Rails.application.config.middleware.insert 0, UrlRedirectMiddleware
